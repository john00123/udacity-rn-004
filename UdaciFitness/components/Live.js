    ...
    if ( status === 'denied'){
      return(
        ...
        <Foundation name = 'alert' size = {50} />
          <Text>
            You denied you location. You can fix this by visiting you settings and enabling location services for this app.
          </Text>
        </View>
      )
    }
      ...
      return(
        <View style = { styles.center }>
          <Foundation name = 'alert' size = {50} />
            ...
            <TouchableOpacity
              onPress = {this.askPermission} style = {styles.button}
            >
              <Text
